...
describe("phonegap notifications", function () {
    var notification = require('ripple/platform/phonegap.proto/1.0/bridge/notification'),
    ...
    it("it calls into the UI to vibrate the device", function () {
        ...
        notification.vibrate(null, null, [500]);
    ...
    it("it opens a notification with the supplied message", function () {
        ...
        notification.alert(null, null, ["His name was Robert Paulson"]);
